  ...
  results: [
    {
      ...
      description:
        "Developed web assets from PSDs mockups and wireframes to HTML, CSS, JavaScript. Created responsive web designs, cross-browser and cross-device development. Created, designed, and wrote apps to increase non-technical team members’ productivity. Revamped most of Guess' transactional emails for NA market with a focus on code quality, web analytics and performance. Increased its revenue over $1 million in the first 3 months and maintaining an average of $.5 million per month. Worked with back-end to programmatically pull data using XML, XSLT and JSON. Spoof tested Akamai network servers.",
      category: "Developer",
      links: []
    },
    {
      ...
      url: "",
      description:
        "Used WordPress and PHP. Created Marketing landing pages, banners for ad agencies using SASS & LESS libraries, Bootstrap, Materialize, Bourbon and Neat. Developed MVP’s web applications for startups using javascript frameworks like Angular or React. Focused on Object-oriented programming, DOM manipulation and RESTful Web Services. Clients: Advertising Agencies (Grupo Gallegos); Startups (S&P Landscaping Services, Advanced Translation Services).",
      category: "Developer",
      links: []
    },
    {
      ...
      description:
        "Worked for Grupo Gallegos, an award winning multicultural agency and one of the leaders of the Latino market in the US. Led Social Media team responsible for social content production to produce weekly content calendars and reports. Managed vendors to produce digital assets like landing pages and web applications. Focused on UI and UX designs. Optimized paid media until reaching one of the lowest CPE $.02(Cost Per Engagement) and CPF $.20(Cost Per Fan) of the industry. Built the most relevant Facebook pages for the US Hispanic market for two of my clients. Clients: California Milk Processor Board (Got Milk?); Valvoline; Comcast-Xfinity. JC Penney. Targeted to the US Hispanic Market.",
      category: "Marketer",
      links: []
    },
    {
